"""
Modified PDF Parser Module

This module contains a modified version of the PDF parsing functionality with an adjusted
white ratio threshold for better detection of two-column layouts.
"""
